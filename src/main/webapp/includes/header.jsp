                    ...
                    <li>
                        <div class="dropdown">
                            <a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#"> 
                                <img src="${ currentUser.avatar }" alt="user-img" width="36" class="img-circle" />
                                <b class="hidden-xs">${ currentUser.fullname }</b> 
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="profile-user">Thông tin cá nhân</a></li>
