                                    ...
                                    <tbody>
                                    	<c:forEach items="${ listJobs }" var="item">
	                                        <tr>
	                                            ...
	                                            <td>
	                                                <a href="groupwork-update?id=${ item.id }" class="btn btn-sm btn-primary">Sửa</a>
	                                                <a href="groupwork-delete?id=${ item.id }" class="btn btn-sm btn-danger">Xóa</a>
	                                                <a href="groupwork-details?id=${ item.id }" class="btn btn-sm btn-info">Xem</a>
	                                            </td>
	                                        </tr>
                                    	</c:forEach>
                                    </tbody>
