                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="job">
                                        	<c:forEach items="${ listJobs }" var="job">
                                        		<option value="${ job.id }" <c:if test="${task.jobId == job.id}">selected</c:if>>
                                        			${ job.name }
                                        		</option>
                                        	</c:forEach>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Tên công việc" name="name"
                                            value="${ task.name }" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="user">
                                        	<c:forEach items="${ listUsers }" var="user">
                                        		<option value="${ user.id }" <c:if test="${task.userId == user.id}">selected</c:if>>
                                        			${ user.fullname }
                                        		</option>
                                        	</c:forEach>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="start_date"
										       ...
										       placeholder="dd/MM/yyyy" class="form-control form-control-line"> 
                                    </div>
                                </div>
                                <div class="form-group">
